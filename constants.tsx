...
export const ICONS = {
  ...
  Trash: ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="m14.74 9-.34 6m-4.77 0L9.31 9m1.11-1.31L12 3h0l1.58 4.69m4.12 0H5.7l.63 11.45a2.25 2.25 0 0 0 2.24 2.13h6.86a2.25 2.25 0 0 0 2.24-2.13l.63-11.45ZM9 12.75V15m3-2.25V15m3-2.25V15" />
    </svg>
  ),
